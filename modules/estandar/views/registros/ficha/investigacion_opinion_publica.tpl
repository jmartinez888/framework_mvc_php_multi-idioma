        ...
        <div class="pf-content">   
            <div class="panel panel-default">
                ...
                {if count($title)>1}
                    ...
                    {/for}
                {/if}</strong>   
                <label class="pull-right" >Exportar:  <a  href="{$_layoutParams.root}monitoreo/_exportaEstacionMonitoreo/{$estacion.Esm_IdEstacionMonitoreo}/{$idvars}" target="_blank"><i class="icon-share"></i>{$lenguaje.label_exportar|default:'PDF'}</a> | <a  href="{$_layoutParams.root}bdrecursos/share/excel/{$tabla}/{$subtema}" target="_blank"><i class="icon-share"></i>{$lenguaje.label_exportar|default:'Excel'}</a></label>
                </div>      
                        ...
                        <table class="table table-user-information"> 
                            ...
                            {if isset($datos) && count($datos)}
                                {foreach from=$datos item=dato}
                                    ...
                                    <tr>                            
                                        <td colspan="2">
                                            <a target="_blank" title="Ver Datos" href="{$_layoutParams.root}bdrecursos/registros/opinionpublica/pregunta/{$dato.$campo_id}/{$id_estandar}">
                                                {$dato.$campo_pregunta}
                                            </a>                                            
                                        </td>                                            
                                    </tr>
