...
class registrosModel extends Model 
{
    ...
    public function getCantidadPorColumna($tabla, $columnas_groupby, $condicion='')
    {
        $post = $this->_db->query("SELECT $columnas_groupby, COUNT(*) total FROM $tabla $condicion GROUP BY $columnas_groupby");
        return $post->fetchAll();
    }
}
