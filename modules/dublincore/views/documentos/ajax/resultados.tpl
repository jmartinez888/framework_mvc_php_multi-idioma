        ...
        <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-6 col-md-offset-3 div-filtro text-center">
                ...
                <a class="badge" href="{$_layoutParams.root_clear}dublincore/documentos/buscarporpalabras/{$palabrabuscada|default:'all'}/all/{$filtroTipo|default:'all'}/{$filtroTipo|default:'all'}/{$filtroPais|default:'all'}">
                 Tema: {$filtroTema}  <i class="fa fa-times"></i> 
                </a>
                {/if}
                {if isset($filtroTipo)}
                <input type="hidden" id= "filtrotipodocumento" value="{$filtroTipo}">
                <a class="badge" href="{$_layoutParams.root_clear}dublincore/documentos/buscarporpalabras/{$palabrabuscada|default:'all'}/{$filtroTema|default:'all'}/all/{$filtroPais|default:'all'}">
                ...
                <a class="badge" href="{$_layoutParams.root_clear}dublincore/documentos/buscarporpalabras/{$palabrabuscada|default:'all'}/{$filtroTema|default:'all'}/{$filtroTipo|default:'all'}/all/{$filtroPais|default:'all'}">
                 Tipo: {$filtroAutor} <i class="fa fa-times"></i>               
                </a>
                {/if}
                {if isset($filtroPais)}
                <input type="hidden" id= "filtropaisdocumento" value="{$filtroPais}">
                <a class="badge" href="{$_layoutParams.root_clear}dublincore/documentos/buscarporpalabras/{$palabrabuscada|default:'all'}/{$filtroTema|default:'all'}/{$filtroTipo|default:'all'}/all">
