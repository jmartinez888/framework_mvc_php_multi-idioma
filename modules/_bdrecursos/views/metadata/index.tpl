                                ...
                                <div class="row-fluid">                                               
                                    ...
                                    <div class="form-inline">
                                        {if $_acl->permiso("editar_metadata_recurso")}
                                            <center><a href="{$_layoutParams.root}mapa/gestorcapa/{$capa.tic_Nombre}/{$capa.Cap_Idcapa}" id="bt_editar_metadata" name="bt_editar_metadata"  class="btn btn-success ">{$lenguaje["editar_bdrecursos"]}</a></center>
                                        {/if}
                                    </div>
                                </div>
                            {/foreach}
