...
<div id="raizaMenu" clas="col-xs-3 col-sm-3 col-md-2 col-lg-2">
  <ul clas="col-xs-3 col-sm-3 col-md-2 col-lg-2">
    ...
    <li>/</li>
    <li>
      <a class='actual' > Compartir datos desde JSON </a>
    </li>
  </ul>     
</div>
<div class="container-fluid">
	<div class="row">
        <div class="col-md-12">
            <h2 class="tit-pagina-principal"><center>Compartir datos desde JSON</center></h2>           
        </div>       
    </div> 
    <div class="row">
						...
						<div class="container col-md-12">
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<a href="{$_layoutParams.root}bdrecursos/share/json/recurso" target="_blank">{$_layoutParams.root}bdrecursos/share/json/recurso </a> 
									
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-body">
									<p>Generar JSON para los registros: </p>
									<form id="form1" method="post" data-toggle="validator" role="form" autocomplete="on">
                                        ...
                                        <div class="form-group col-md-5 col-md-offset-3">
                                        	<div class="col-md-12">
                                        		<center>
                                        			<button type="submit" class="btn btn-success" id="bt_generar_json" name="bt_generar_json">
	                                           			Generar
	                                           		</button>
                                        		</center>
	                                         </div>
                                        ...
                                        {if isset($link_json)}
                                        	<div class="form-group col-md-5 col-md-offset-3">
	                                        	<div class="col-md-12">
	                                        		...
	                                        		<a href="{$_layoutParams.root}bdrecursos/share/json/{$nombre_tabla}/{$id_recurso}" class="btn btn-info" target="_blank">{$_layoutParams.root}bdrecursos/share/json/{$nombre_tabla}/{$id_recurso}</a>
	                                        		</center>
		                                         </div>
	                                        </div>
                                        {/if}                                        
