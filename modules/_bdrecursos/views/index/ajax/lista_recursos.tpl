                        ...
                        <tr>                       
                            ...
                            <td style=" text-align: center">
                                ...
                                {if $_acl->permiso("editar_recurso")}
                                    <a type="button" title="{$lenguaje["editar_bdrecursos"]}" class="btn btn-default btn-sm glyphicon glyphicon-pencil" href="{$_layoutParams.root}bdrecursos/index/index/{$datos.Rec_IdRecurso}">
                                    </a>
                                {/if}
