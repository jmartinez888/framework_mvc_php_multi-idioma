...
class indexController extends bdrecursosController
{
    ...
    public function index($recurso = false) 
    {
        ...
        if ($this->botonPress("bt_registrar")) 
        {
                ...
                $this->getTexto("tb_origen_recurso") && $this->getTexto("sl_estandar_recurso")) 
            {
                ...
                {      
                    ...
                    $this->getTexto("sl_estandar_recurso"), $this->getTexto("tb_origen_recurso"), 'es');
        ...
        if ($this->filtrarInt($recurso)) 
        {            
            $this->_acl->acceso("editar_recurso");
            $recurso = $this->_bdrecursos->getRecursoCompletoXid($this->filtrarInt($recurso));
