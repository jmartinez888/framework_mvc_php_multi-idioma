        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-heading">Cargar Archivo</div>
                  <div class="panel-body">                
                    <div id="seleccionar_hoja" align="center">                     
                            <div class="col-md-12">
                                <label for="fecha_actualizacion" control-label>Seleccionar Hoja</label>         
                                <select id="hojas" name="hojas">
                                    <option value=''>Seleccione</option>
                                    {foreach $nombrehojas as $nombrehoja}
                                    <option value='{$nombrehoja}'>{$nombrehoja}</option>
                                    {/foreach}
                                </select>
                                <input type="hidden" value="{$data}" name="data_tabla" id="data_tabla"></input>
                            </div>                     
                    </div>                
